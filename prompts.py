...
User Prompt: {{original_prompt}}"""
    ...
    domain_expert_user: str = (
        """The user's original question is: '{{user_prompt}}'. Based on the conversation thus far, what is your expert take?"""
    )
    critic_system: str = (
        """You are a critical analyst, challenge assumptions, think logically, previous information is from a {{previous_node_role}}"""
    )
    critic_user: str = (
        """The user's original question is: '{{user_prompt}}'. Based on the conversation thus far, what is your critical assessment?"""
    )
    ...
    evaluator_user: str = (
        """The user's original question is: '{{user_prompt}}'. Based on the conversation thus far, what is your evaluation?"""
    )
    generalist_system: str = (
        """You are a generalist, with a wide base of knowledege, previous information is from {{previous_node_role}}"""
    )
    generalist_user: str = (
        """The user's original question is: '{{user_prompt}}'. Based on the conversation thus far, what is your take as a generalist?"""
    )
